...
import { Stream as Stream$2 } from "node:stream";
...
function requireReact_production() {
  ...
  function ReactElement(type3, key, self2, source, owner, props) {
    self2 = props.ref;
    return {
  ...
  function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
    ...
    if ("undefined" === type3 || "boolean" === type3) children = null;
    ...
    if (isArrayImpl(children))
      for (var i = 0; i < children.length; i++)
        nameSoFar = children[i], type3 = nextNamePrefix + getElementKey(nameSoFar, i), invokeCallback += mapIntoArray(
          nameSoFar,
          array,
          escapedPrefix,
          type3,
      ...
      for (children = i.call(children), i = 0; !(nameSoFar = children.next()).done; )
        nameSoFar = nameSoFar.value, type3 = nextNamePrefix + getElementKey(nameSoFar, i++), invokeCallback += mapIntoArray(
          nameSoFar,
          array,
          escapedPrefix,
          type3,
  ...
  react_production.createElement = function(type3, config, children) {
    ...
    return ReactElement(type3, key, void 0, void 0, null, props);
  };
  ...
  react_production.memo = function(type3, compare) {
    return {
  ...
  (function(module, exports) {
    "production" !== process.env.NODE_ENV && function() {
      ...
      function getComponentNameFromType(type3) {
        if (null == type3) return null;
        if ("function" === typeof type3)
          return type3.$$typeof === REACT_CLIENT_REFERENCE$2 ? null : type3.displayName || type3.name || null;
        if ("string" === typeof type3) return type3;
        switch (type3) {
        ...
        if ("object" === typeof type3)
          switch ("number" === typeof type3.tag && console.error(
            ...
            case REACT_MEMO_TYPE:
              return innerType = type3.displayName || null, null !== innerType ? innerType : getComponentNameFromType(type3.type) || "Memo";
            case REACT_LAZY_TYPE:
      ...
      function describeUnknownElementTypeFrameInDEV(type3) {
        if (null == type3) return "";
        if ("function" === typeof type3) {
          var prototype = type3.prototype;
          return describeNativeComponentFrame(
            type3,
            !(!prototype || !prototype.isReactComponent)
          );
        }
        if ("string" === typeof type3) return describeBuiltInComponentFrame(type3);
        switch (type3) {
          case REACT_SUSPENSE_TYPE:
        ...
        if ("object" === typeof type3)
          switch (type3.$$typeof) {
            case REACT_FORWARD_REF_TYPE:
              return type3 = describeNativeComponentFrame(type3.render, false), type3;
            case REACT_MEMO_TYPE:
              return describeUnknownElementTypeFrameInDEV(type3.type);
            case REACT_LAZY_TYPE:
              prototype = type3._payload;
              type3 = type3._init;
              try {
                return describeUnknownElementTypeFrameInDEV(type3(prototype));
              } catch (x) {
              }
          }
        return "";
      ...
      function ReactElement(type3, key, self2, source, owner, props) {
        ...
        null !== (void 0 !== self2 ? self2 : null) ? Object.defineProperty(type3, "ref", {
          enumerable: false,
      ...
      function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
        ...
        if (isArrayImpl(children))
          for (var i = 0; i < children.length; i++)
            nameSoFar = children[i], type3 = childKey + getElementKey(nameSoFar, i), invokeCallback += mapIntoArray(
              nameSoFar,
              array,
              escapedPrefix,
              type3,
          ...
          for (i === children.entries && (didWarnAboutMaps || console.warn(
            ...
            nameSoFar = nameSoFar.value, type3 = childKey + getElementKey(nameSoFar, i++), invokeCallback += mapIntoArray(
              nameSoFar,
              array,
              escapedPrefix,
              type3,
      ...
      exports.createElement = function(type3, config, children) {
        if (isValidElementType(type3))
          for (var i = 2; i < arguments.length; i++)
            validateChildKeys(arguments[i], type3);
        else {
          i = "";
          if (void 0 === type3 || "object" === typeof type3 && null !== type3 && 0 === Object.keys(type3).length)
          ...
          if (null === type3) var typeString = "null";
          else
            isArrayImpl(type3) ? typeString = "array" : void 0 !== type3 && type3.$$typeof === REACT_ELEMENT_TYPE ? (typeString = "<" + (getComponentNameFromType(type3.type) || "Unknown") + " />", i = " Did you accidentally export a JSX literal instead of a component?") : typeString = typeof type3;
          console.error(
        ...
        typeString && defineKeyPropWarningGetter(
          i,
          "function" === typeof type3 ? type3.displayName || type3.name || "Unknown" : type3
        );
        return ReactElement(type3, typeString, void 0, void 0, getOwner(), i);
      };
      ...
      exports.memo = function(type3, compare) {
        isValidElementType(type3) || console.error(
          "memo: The first argument must be a component. Instead received: %s",
          null === type3 ? "null" : typeof type3
        );
        compare = {
          $$typeof: REACT_MEMO_TYPE,
          type: type3,
...
function flatten$2(input) {
  const { indices: indices2 } = this;
  const existing = indices2.get(input);
  if (existing)
    return [existing];
  if (input === void 0)
    return UNDEFINED;
  ...
  indices2.set(input, index2);
  stringify$3.call(this, input, index2);
  return index2;
}
function stringify$3(input, index2) {
  const { deferred, plugins, postPlugins } = this;
  const str = this.stringified;
  const stack = [[input, index2]];
  while (stack.length > 0) {
    const [input2, index22] = stack.pop();
    const partsForObj = (obj) => Object.keys(obj).map((k) => `"_${flatten$2.call(this, k)}":${flatten$2.call(this, obj[k])}`).join(",");
    let error2 = null;
        ...
        if (!isArray2 && plugins) {
          for (const plugin of plugins) {
            ...
            if (Array.isArray(pluginResult)) {
              ...
              if (rest.length > 0) {
                str[index22] += `,${rest.map((v) => flatten$2.call(this, v)).join(",")}`;
              }
              str[index22] += "]";
              break;
            }
        ...
        if (!pluginHandled) {
          ...
          if (isArray2) {
            for (let i = 0; i < input2.length; i++)
              result += (i ? "," : "") + (i in input2 ? flatten$2.call(this, input2[i]) : HOLE);
            str[index22] = `${result}]`;
            ...
            str[index22] = `["${TYPE_REGEXP$1}",${JSON.stringify(
              input2.source
            )},${JSON.stringify(input2.flags)}]`;
          } else if (input2 instanceof Set) {
            if (input2.size > 0) {
              str[index22] = `["${TYPE_SET}",${[...input2].map((val) => flatten$2.call(this, val)).join(",")}]`;
            } else {
            ...
            if (input2.size > 0) {
              str[index22] = `["${TYPE_MAP}",${[...input2].flatMap(([k, v]) => [
                flatten$2.call(this, k),
                flatten$2.call(this, v)
              ]).join(",")}]`;
            } else {
        ...
        switch (type3) {
          ...
          case TYPE_PROMISE:
            if (hydrated[b]) {
              ...
              deferred[b] = d2;
              set(hydrated[index22] = d2.promise);
            }
            continue;
          case TYPE_ERROR:
...
async function decode$4(readable, options) {
...
function encode$1(input, options) {
  ...
  const readable = new ReadableStream({
    async start(controller) {
      const id = flatten$2.call(encoder, input);
      if (Array.isArray(id)) {
        ...
        for (const [deferredId, deferred] of Object.entries(encoder.deferred)) {
          ...
          seenPromises.add(
            encoder.deferred[Number(deferredId)] = raceSignal(
              ...
              (resolved) => {
                const id2 = flatten$2.call(encoder, resolved);
...
`
              ...
              (reason) => {
                ...
                const id2 = flatten$2.call(encoder, reason);
                if (Array.isArray(id2)) {
                  controller.enqueue(
                    textEncoder.encode(
...
function raceSignal(promise, signal) {
  ...
  const abort = new Promise((resolve3, reject) => {
...
const cookieNameRegExp$1 = /^[\u0021-\u003A\u003C\u003E-\u007E]+$/;
const cookieValueRegExp$1 = /^[\u0021-\u003A\u003C-\u007E]*$/;
const domainValueRegExp$1 = /^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i;
const pathValueRegExp$1 = /^[\u0020-\u003A\u003D-\u007E]*$/;
const __toString$1 = Object.prototype.toString;
...
function parse$c(str, options) {
  ...
  if (len < 2)
    return obj;
  const dec = (options == null ? void 0 : options.decode) || decode$3;
  let index2 = 0;
  do {
    ...
    const keyStartIdx = startIndex$1(str, index2, eqIdx);
    const keyEndIdx = endIndex$1(str, eqIdx, keyStartIdx);
    const key = str.slice(keyStartIdx, keyEndIdx);
    if (obj[key] === void 0) {
      let valStartIdx = startIndex$1(str, eqIdx + 1, endIdx);
      let valEndIdx = endIndex$1(str, endIdx, valStartIdx);
...
function startIndex$1(str, index2, max2) {
  do {
...
function endIndex$1(str, index2, min2) {
  while (index2 > min2) {
    const code = str.charCodeAt(--index2);
    if (code !== 32 && code !== 9)
      return index2 + 1;
...
function serialize$1(name, val, options) {
  ...
  if (!cookieNameRegExp$1.test(name)) {
    throw new TypeError(`argument name is invalid: ${name}`);
  }
  const value = enc(val);
  if (!cookieValueRegExp$1.test(value)) {
  ...
  if (options.domain) {
    if (!domainValueRegExp$1.test(options.domain)) {
      throw new TypeError(`option domain is invalid: ${options.domain}`);
    }
    str += "; Domain=" + options.domain;
  }
  if (options.path) {
    if (!pathValueRegExp$1.test(options.path)) {
...
function isDate$2(val) {
  return __toString$1.call(val) === "[object Date]";
}
...
setCookie.exports = parse$b;
setCookie.exports.parse = parse$b;
...
function parsePath(path3) {
  ...
  if (path3) {
    ...
    if (hashIndex >= 0) {
      parsedPath.hash = path3.substring(hashIndex);
      path3 = path3.substring(0, hashIndex);
    }
    let searchIndex = path3.indexOf("?");
    if (searchIndex >= 0) {
      parsedPath.search = path3.substring(searchIndex);
      path3 = path3.substring(0, searchIndex);
    }
    if (path3) {
...
function isIndexRoute(route3) {
  return route3.index === true;
}
function convertRoutesToDataRoutes(routes, mapRouteProperties2, parentPath = [], manifest = {}) {
  return routes.map((route3, index2) => {
    let treePath = [...parentPath, String(index2)];
    let id = typeof route3.id === "string" ? route3.id : treePath.join("-");
    invariant(
      route3.index !== true || !route3.children,
    ...
    if (isIndexRoute(route3)) {
      let indexRoute = {
        ...route3,
        ...mapRouteProperties2(route3),
        id
      };
...
function convertRouteMatchToUiMatch(match2, loaderData) {
  let { route: route3, pathname, params } = match2;
  return {
    id: route3.id,
    pathname,
    params,
    data: loaderData[route3.id],
    handle: route3.handle
  };
}
function flattenRoutes(routes, branches = [], parentsMeta = [], parentPath = "") {
  let flattenRoute = (route3, index2, relativePath) => {
    let meta = {
      relativePath: relativePath === void 0 ? route3.path || "" : relativePath,
      caseSensitive: route3.caseSensitive === true,
    ...
    if (route3.children && route3.children.length > 0) {
      invariant(
      ...
      flattenRoutes(route3.children, branches, routesMeta, path3);
    }
    if (route3.path == null && !route3.index) {
      return;
    }
    branches.push({
      path: path3,
      score: computeScore(path3, route3.index),
      routesMeta
    });
  };
  routes.forEach((route3, index2) => {
    var _a;
    if (route3.path === "" || !((_a = route3.path) == null ? void 0 : _a.includes("?"))) {
      flattenRoute(route3, index2);
    } else {
      for (let exploded of explodeOptionalSegments(route3.path)) {
        flattenRoute(route3, index2, exploded);
      }
    }
  });
  return branches;
...
function explodeOptionalSegments(path3) {
  ...
  return result.map(
    (exploded) => path3.startsWith("/") && exploded === "" ? "/" : exploded
  );
}
...
var splatPenalty = -2;
var isSplat = (s2) => s2 === "*";
function computeScore(path3, index2) {
  let segments = path3.split("/");
...
function compilePath(path3, caseSensitive = false, end = true) {
  warning(
    path3 === "*" || !path3.endsWith("*") || path3.endsWith("/*"),
    `Route path "${path3}" will be treated as if it were "${path3.replace(/\*$/, "/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${path3.replace(/\*$/, "/*")}".`
  );
  let params = [];
  let regexpSource = "^" + path3.replace(/\/*\*?$/, "").replace(/^\/*/, "/").replace(/[\\.*+^${}|()[\]]/g, "\\$&").replace(
    /\/:([\w-]+)(\?)?/g,
...
var ErrorResponseImpl = class {
  constructor(status3, statusText, data2, internal2 = false) {
    this.status = status3;
...
var defaultMapRouteProperties = (route3) => ({
  hasErrorBoundary: Boolean(route3.hasErrorBoundary)
});
...
function createStaticHandler(routes, opts) {
  ...
  async function query3(request2, {
    requestContext,
    ...
    let location2 = createLocation("", createPath(url2), null, "default");
    let matches = matchRoutes(dataRoutes, location2, basename2);
    if (!isValidMethod(method) && method !== "HEAD") {
      let error2 = getInternalRouterError(405, { method });
      let { matches: methodNotAllowedMatches, route: route3 } = getShortCircuitMatches(dataRoutes);
      return {
        basename: basename2,
        location: location2,
      ...
      let { matches: notFoundMatches, route: route3 } = getShortCircuitMatches(dataRoutes);
      return {
        basename: basename2,
        location: location2,
  ...
  async function queryRoute(request2, {
    routeId,
    requestContext,
    dataStrategy
  } = {}) {
    ...
    let match2 = routeId ? matches.find((m2) => m2.route.id === routeId) : getTargetMatch(matches, location2);
    if (routeId && !match2) {
  ...
  async function queryImpl(request2, location2, matches, requestContext, dataStrategy, skipLoaderErrorBubbling, routeMatch) {
    invariant(
      request2.signal,
      "query()/queryRoute() requests must contain an AbortController signal"
    );
    try {
      if (isMutationMethod(request2.method)) {
  ...
  async function submit(request2, matches, actionMatch, requestContext, dataStrategy, skipLoaderErrorBubbling, isRouteRequest) {
    ...
    if (!actionMatch.route.action && !actionMatch.route.lazy) {
      ...
      if (request2.signal.aborted) {
        throwStaticHandlerAbortedError(request2, isRouteRequest);
      }
    }
  ...
  async function loadRouteData(request2, matches, requestContext, dataStrategy, skipLoaderErrorBubbling, routeMatch, pendingActionResult) {
    ...
    let executedLoaders = new Set(
      matchesToLoad.map((match2) => match2.route.id)
    );
  ...
  async function callDataStrategy(type3, request2, matchesToLoad, matches, isRouteRequest, requestContext, dataStrategy) {
...
function getStaticContextFromError(routes, context, error2) {
  let newContext = {
    ...context,
    statusCode: isRouteErrorResponse(error2) ? error2.status : 500,
    errors: {
      [context._deepestRenderedBoundaryId || routes[0].id]: error2
    }
  };
  return newContext;
}
function throwStaticHandlerAbortedError(request2, isRouteRequest) {
  if (request2.signal.reason !== void 0) {
    throw request2.signal.reason;
  }
  let method = isRouteRequest ? "queryRoute" : "query";
  throw new Error(
    `${method}() call aborted without an \`AbortSignal.reason\`: ${request2.method} ${request2.url}`
  );
}
function normalizeTo(location2, matches, basename2, to, fromRouteId, relative2) {
  ...
  if (to == null) {
    path3.search = location2.search;
    path3.hash = location2.hash;
  }
...
async function loadLazyRouteModule(route3, mapRouteProperties2, manifest) {
  if (!route3.lazy) {
    return;
  }
  let lazyRoute = await route3.lazy();
  if (!route3.lazy) {
    return;
  }
  let routeToUpdate = manifest[route3.id];
...
async function callDataStrategyImpl(dataStrategyImpl, type3, state, request2, matchesToLoad, matches, fetcherKey, manifest, mapRouteProperties2, requestContext) {
  ...
  let dsMatches = matches.map((match2, i) => {
    ...
    let resolve3 = async (handlerOverride) => {
...
async function callLoaderOrAction(type3, request2, match2, loadRoutePromise, handlerOverride, staticContext) {
  let result;
  let onReject;
    ...
    let actualHandler = (ctx) => {
      if (typeof handler !== "function") {
        return Promise.reject(
          new Error(
            `You cannot call the handler for a route which defines a boolean "${type3}" [routeId: ${match2.route.id}]`
          )
        );
      }
      return handler(
  ...
  try {
    let handler = match2.route[type3];
    if (loadRoutePromise) {
      if (handler) {
        let handlerError;
        ...
        handler = match2.route[type3];
        if (handler) {
          result = await runHandler(handler);
        } else if (type3 === "action") {
          let url2 = new URL(request2.url);
...
async function convertDataStrategyResultToDataResult(dataStrategyResult) {
  ...
  let { result, type: type3 } = dataStrategyResult;
  if (isResponse(result)) {
    let data2;
    try {
      let contentType3 = result.headers.get("Content-Type");
      if (contentType3 && /\bapplication\/json\b/.test(contentType3)) {
        if (result.body == null) {
          data2 = null;
        } else {
...
function normalizeRelativeRoutingRedirectResponse(response2, request2, routeId, matches, basename2) {
  let location2 = response2.headers.get("Location");
  invariant(
    location2,
  ...
  if (!ABSOLUTE_URL_REGEX.test(location2)) {
    ...
    response2.headers.set("Location", location2);
  }
  return response2;
}
...
function getShortCircuitMatches(routes) {
  let route3 = routes.length === 1 ? routes[0] : routes.find((r) => r.index || !r.path || r.path === "/") || {
...
function getInternalRouterError(status3, {
  pathname,
  routeId,
  method,
  type: type3,
...
function useHref(to, { relative: relative2 } = {}) {
  invariant(
    useInRouterContext(),
  ...
  let { hash, pathname, search } = useResolvedPath(to, { relative: relative2 });
...
function useResolvedPath(to, { relative: relative2 } = {}) {
  let { matches } = reactExports.useContext(RouteContext);
  let { pathname: locationPathname } = useLocation();
  let routePathnamesJson = JSON.stringify(getResolveToMatches(matches));
  return reactExports.useMemo(
    ...
    [to, routePathnamesJson, locationPathname, relative2]
  );
}
...
function useRouteContext(hookName) {
  let route3 = reactExports.useContext(RouteContext);
  invariant(route3, getDataRouterConsoleError(hookName));
  return route3;
}
function useCurrentRouteId(hookName) {
  let route3 = useRouteContext(hookName);
  let thisRoute = route3.matches[route3.matches.length - 1];
  invariant(
    thisRoute.route.id,
...
function mapRouteProperties(route3) {
  let updates = {
    // Note: this check also occurs in createRoutesFromChildren so update
    // there if you change this -- please and thank you!
    hasErrorBoundary: route3.hasErrorBoundary || route3.ErrorBoundary != null || route3.errorElement != null
  };
  if (route3.Component) {
    {
      if (route3.element) {
    ...
    Object.assign(updates, {
      element: reactExports.createElement(route3.Component),
      Component: void 0
    });
  }
  if (route3.HydrateFallback) {
    {
      if (route3.hydrateFallbackElement) {
        warning(
          false,
    ...
    Object.assign(updates, {
      hydrateFallbackElement: reactExports.createElement(route3.HydrateFallback),
      HydrateFallback: void 0
    });
  }
  if (route3.ErrorBoundary) {
    {
      if (route3.errorElement) {
        warning(
          false,
    ...
    Object.assign(updates, {
      errorElement: reactExports.createElement(route3.ErrorBoundary),
...
async function loadRouteModule(route3, routeModulesCache) {
  if (route3.id in routeModulesCache) {
    return routeModulesCache[route3.id];
  }
  try {
    ...
    routeModulesCache[route3.id] = routeModule;
    return routeModule;
  } catch (error2) {
    console.error(
      `Error loading route module \`${route3.module}\`, reloading page...`
    );
    console.error(error2);
...
function getKeyedLinksForMatches(matches, routeModules, manifest) {
  let descriptors = matches.map((match2) => {
    ...
    let route3 = manifest.routes[match2.route.id];
    return [
      route3 && route3.css ? route3.css.map((href) => ({ rel: "stylesheet", href })) : [],
...
async function getKeyedPrefetchLinks(matches, manifest, routeModules) {
  let links = await Promise.all(
    matches.map(async (match2) => {
      let route3 = manifest.routes[match2.route.id];
      if (route3) {
        let mod = await loadRouteModule(route3, routeModules);
...
function getModuleLinkHrefs(matches, manifestPatch) {
  return dedupeHrefs(
    matches.map((match2) => {
      let route3 = manifestPatch.routes[match2.route.id];
      if (!route3) return [];
      let hrefs = [route3.module];
      if (route3.imports) {
        hrefs = hrefs.concat(route3.imports);
      }
      return hrefs;
    }).flat(1)
  );
  ...
  let scriptTag = value ? /* @__PURE__ */ reactExports.createElement(
    "script",
    {
      ...
      dangerouslySetInnerHTML: {
        __html: `window.__reactRouterContext.streamController.enqueue(${escapeHtml$4(
...
function decodeViaTurboStream(body, global2) {
  return decode$4(body, {
    plugins: [
      (type3, ...rest) => {
        if (type3 === "SanitizedError") {
        ...
        if (type3 === "ErrorResponse") {
          let [data2, status3, statusText] = rest;
          return {
            value: new ErrorResponseImpl(status3, statusText, data2)
          };
        }
        if (type3 === "SingleFetchRedirect") {
          return { value: { [SingleFetchRedirectSymbol]: rest[0] } };
        }
        if (type3 === "SingleFetchClassInstance") {
          return { value: rest[0] };
        }
        if (type3 === "SingleFetchFallback") {
          return { value: void 0 };
        }
      }
    ]
...
function RemixRootDefaultErrorBoundary({
  ...
  if (isRouteErrorResponse(error2)) {
    return /* @__PURE__ */ reactExports.createElement(BoundaryShell, { title: "Unhandled Thrown Response!" }, /* @__PURE__ */ reactExports.createElement("h1", { style: { fontSize: "24px" } }, error2.status, " ", error2.statusText), heyDeveloper);
  }
  let errorInstance;
...
function groupRoutesByParentId(manifest) {
  let routes = {};
  Object.values(manifest).forEach((route3) => {
    if (route3) {
      let parentId = route3.parentId || "";
      if (!routes[parentId]) {
        routes[parentId] = [];
      }
      routes[parentId].push(route3);
    }
  });
  return routes;
}
function getRouteComponents(route3, routeModule, isSpaMode) {
  let Component4 = getRouteModuleComponent(routeModule);
  let HydrateFallback = routeModule.HydrateFallback && (!isSpaMode || route3.id === "root") ? routeModule.HydrateFallback : route3.id === "root" ? RemixRootDefaultHydrateFallback : void 0;
  let ErrorBoundary = routeModule.ErrorBoundary ? routeModule.ErrorBoundary : route3.id === "root" ? () => /* @__PURE__ */ reactExports.createElement(RemixRootDefaultErrorBoundary, { error: useRouteError() }) : void 0;
  if (route3.id === "root" && routeModule.Layout) {
    return {
      ...Component4 ? {
...
function createServerRoutes(manifest, routeModules, future, isSpaMode, parentId = "", routesByParentId = groupRoutesByParentId(manifest), spaModeLazyPromise = Promise.resolve({ Component: () => null })) {
  return (routesByParentId[parentId] || []).map((route3) => {
    let routeModule = routeModules[route3.id];
    invariant2(
      routeModule,
      "No `routeModule` available to create server routes"
    );
    let dataRoute = {
      ...getRouteComponents(route3, routeModule, isSpaMode),
      caseSensitive: route3.caseSensitive,
      id: route3.id,
      index: route3.index,
      path: route3.path,
      ...
      // proper fallback
      loader: route3.hasLoader || route3.hasClientLoader ? () => null : void 0
...
function shouldHydrateRouteLoader(route3, routeModule, isSpaMode) {
  return isSpaMode && route3.id !== "root" || routeModule.clientLoader != null && (routeModule.clientLoader.hydrate === true || route3.hasLoader !== true);
}
...
function getPartialManifest(manifest, router2) {
  ...
  paths.forEach((path3) => {
    let matches = matchRoutes(router2.routes, path3, router2.basename);
    if (matches) {
      ...
      try {
        ...
        return /* @__PURE__ */ reactExports.createElement(
          "script",
          {
            ...
            dangerouslySetInnerHTML: { __html: json2 }
          }
        );
      } catch (err) {
        return null;
...
${matches.map(
      (match2, index2) => `import * as route${index2} from ${JSON.stringify(
        manifest.routes[match2.route.id].module
      )};`
    ).join("\n")}
  ${enableFogOfWar ? (
...
import(${JSON.stringify(manifest.entry.module)});`;
  ...
  let routePreloads = matches.map((match2) => {
    let route3 = manifest.routes[match2.route.id];
    return route3 ? (route3.imports || []).concat([route3.module]) : [];
  }).flat(1);
  ...
  ), dedupe(preloads).map((path3) => /* @__PURE__ */ reactExports.createElement(
    "link",
    {
      key: path3,
      rel: "modulepreload",
...
var Link = reactExports.forwardRef(
  function LinkWithRef({
    ...
    let isAbsolute2 = typeof to === "string" && ABSOLUTE_URL_REGEX2.test(to);
    let absoluteHref;
    let isExternal = false;
    if (typeof to === "string" && isAbsolute2) {
      absoluteHref = to;
      if (isBrowser) {
        try {
          let currentUrl = new URL(window.location.href);
          let targetUrl = to.startsWith("//") ? new URL(currentUrl.protocol + to) : new URL(to);
          let path3 = stripBasename(targetUrl.pathname, basename2);
    ...
    let href = useHref(to, { relative: relative2 });
    ...
    let link = (
      ...
      /* @__PURE__ */ reactExports.createElement(
        "a",
        {
          ...
          target,
          "data-discover": !isAbsolute2 && discover === "render" ? "true" : void 0
        }
      )
    );
    return shouldPrefetch && !isAbsolute2 ? /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, link, /* @__PURE__ */ reactExports.createElement(PrefetchPageLinks, { page: href })) : link;
  }
);
...
var NavLink = reactExports.forwardRef(
  function NavLinkWithRef({
    ...
    let path3 = useResolvedPath(to, { relative: rest.relative });
    let location2 = useLocation();
    ...
    useViewTransitionState(path3) && viewTransition === true;
...
var Form = reactExports.forwardRef(
  ({
    ...
    let formAction = useFormAction(action, { relative: relative2 });
    let formMethod = method.toLowerCase() === "get" ? "get" : "post";
    let isAbsolute2 = typeof action === "string" && ABSOLUTE_URL_REGEX2.test(action);
...
function useLinkClickHandler(to, {
  ...
  let location2 = useLocation();
  let path3 = useResolvedPath(to, { relative: relative2 });
  return reactExports.useCallback(
    (event) => {
      if (shouldProcessLinkClick(event, target)) {
        event.preventDefault();
        let replace2 = replaceProp !== void 0 ? replaceProp : createPath(location2) === createPath(path3);
        navigate(to, {
          replace: replace2,
          state,
          preventScrollReset,
...
function useFormAction(action, { relative: relative2 } = {}) {
  let { basename: basename2 } = reactExports.useContext(NavigationContext);
  let routeContext = reactExports.useContext(RouteContext);
  invariant(routeContext, "useFormAction must be used inside a RouteContext");
  let [match2] = routeContext.matches.slice(-1);
  let path3 = { ...useResolvedPath(action ? action : ".", { relative: relative2 }) };
  let location2 = useLocation();
  if (action == null) {
    path3.search = location2.search;
    let params = new URLSearchParams(path3.search);
...
function useViewTransitionState(to, opts = {}) {
  ...
  let path3 = useResolvedPath(to, { relative: opts.relative });
  ...
  return matchPath(path3.pathname, nextPath) != null || matchPath(path3.pathname, currentPath) != null;
}
function StaticRouterProvider({
  ...
  if (hydrate2 !== false) {
    ...
    let json2 = htmlEscape(JSON.stringify(JSON.stringify(data2)));
...
function createStaticRouter(routes, context, opts = {}) {
  ...
  let matches = context.matches.map((match2) => {
    let route3 = manifest[match2.route.id] || match2.route;
    return {
      ...match2,
      route: route3
    };
...
function ServerRouter({
  ...
  for (let match2 of context.staticHandlerContext.matches) {
    ...
    let route3 = routeModules[routeId];
    let manifestRoute = context.manifest.routes[routeId];
    if (route3 && manifestRoute && shouldHydrateRouteLoader(manifestRoute, route3, context.isSpaMode) && (route3.HydrateFallback || !manifestRoute.hasLoader)) {
...
function createEntryRouteModules(manifest) {
  return Object.keys(manifest).reduce((memo2, routeId) => {
    let route3 = manifest[routeId];
    if (route3) {
      memo2[routeId] = route3.module;
    }
    return memo2;
  }, {});
}
...
function matchServerRoutes(routes, pathname, basename2) {
...
function stripIndexParam2(request2) {
  ...
  return new Request(url2.href, init2);
}
function stripRoutesParam(request2) {
  let url2 = new URL(request2.url);
  url2.searchParams.delete("_routes");
  let init2 = {
    method: request2.method,
    body: request2.body,
    headers: request2.headers,
...
function createRoutes(manifest, parentId = "", routesByParentId = groupRoutesByParentId2(manifest)) {
  return (routesByParentId[parentId] || []).map((route3) => ({
    ...route3,
    children: createRoutes(manifest, route3.id, routesByParentId)
  }));
}
function createStaticHandlerDataRoutes(manifest, future, parentId = "", routesByParentId = groupRoutesByParentId2(manifest)) {
  return (routesByParentId[parentId] || []).map((route3) => {
    let commonRoute = {
      ...
      hasErrorBoundary: route3.id === "root" || route3.module.ErrorBoundary != null,
      id: route3.id,
      path: route3.path,
      // Need to use RR's version in the param typed here to permit the optional
      // context even though we know it'll always be provided in remix
      loader: route3.module.loader ? async (args) => {
        if (args.request.headers.has("X-React-Router-Prerender-Data")) {
          ...
          let decoded = await decodeViaTurboStream(stream2, global);
          let data2 = decoded.value;
          invariant3(
            data2 && route3.id in data2,
            "Unable to decode prerendered data"
          );
          let result = data2[route3.id];
          invariant3("data" in result, "Unable to process prerendered data");
          return result.data;
        }
        let val = await callRouteHandler(route3.module.loader, args);
        return val;
      } : void 0,
      action: route3.module.action ? (args) => callRouteHandler(route3.module.action, args) : void 0,
      handle: route3.module.handle
    };
    return route3.index ? {
      index: true,
      ...commonRoute
...
function getDocumentHeaders(build, context) {
  ...
  return matches.reduce((parentHeaders, match2, idx) => {
    let { id } = match2.route;
    let route3 = build.routes[id];
    invariant3(route3, `Route with id "${id}" not found in build`);
    let routeModule = route3.module;
...
function prependCookies(parentHeaders, childHeaders) {
  ...
  if (parentSetCookieString) {
    ...
    cookies.forEach((cookie2) => {
      if (!childCookies.has(cookie2)) {
        childHeaders.append("Set-Cookie", cookie2);
      }
    });
  }
}
...
function getSingleFetchDataStrategy2({
  ...
  return async ({ request: request2, matches }) => {
    ...
    let results = await Promise.all(
      matchesToLoad.map((match2) => match2.resolve())
    );
    return results.reduce(
      (acc, result, i) => Object.assign(acc, { [matchesToLoad[i].route.id]: result }),
      {}
...
async function singleFetchAction(build, serverMode, staticHandler, request2, handlerUrl, loadContext, handleError) {
  try {
    let handlerRequest = new Request(handlerUrl, {
      ...
      headers: request2.headers,
      signal: request2.signal,
      ...request2.body ? { duplex: "half" } : void 0
    });
...
async function singleFetchLoaders(build, serverMode, staticHandler, request2, handlerUrl, loadContext, handleError) {
  ...
  try {
    ...
    let loadRouteIds = ((_a = new URL(request2.url).searchParams.get("_routes")) == null ? void 0 : _a.split(",")) || void 0;
    let result = await staticHandler.query(handlerRequest, {
      requestContext: loadContext,
      skipLoaderErrorBubbling: true,
      dataStrategy: getSingleFetchDataStrategy2({
...
function getSingleFetchRedirect(status3, headers, basename2) {
  let redirect22 = headers.get("Location");
  if (basename2) {
    redirect22 = stripBasename(redirect22, basename2) || redirect22;
  }
  return {
    redirect: redirect22,
    status: status3,
    ...
    plugins: [
      (value) => {
        ...
        if (value instanceof ErrorResponseImpl) {
          let { data: data3, status: status3, statusText } = value;
          return ["ErrorResponse", data3, status3, statusText];
        }
...
function derive(build, mode) {
  ...
  let errorHandler = build.entry.module.handleError || ((error2, { request: request2 }) => {
    if (serverMode !== "test" && !request2.signal.aborted) {
      console.error(
...
var createRequestHandler$1 = (build, mode) => {
  let _build;
  let routes;
  let serverMode;
  let staticHandler;
  ...
  return async function requestHandler(request2, loadContext = {}) {
    ...
    if (url2.pathname === manifestUrl) {
      try {
        let res2 = await handleManifestRequest(_build, routes, url2);
        return res2;
      } catch (e) {
        handleError(e);
    ...
    let matches = matchServerRoutes(routes, url2.pathname, _build.basename);
    if (matches && matches.length > 0) {
      Object.assign(params, matches[0].params);
    }
    let response2;
    if (url2.pathname.endsWith(".data")) {
      ...
      response2 = await handleSingleFetchRequest(
        serverMode,
        _build,
        staticHandler,
        request2,
      ...
      if (_build.entry.module.handleDataRequest) {
        response2 = await _build.entry.module.handleDataRequest(response2, {
          context: loadContext,
          params: singleFetchMatches ? singleFetchMatches[0].params : {},
          request: request2
        });
        if (isRedirectResponse(response2)) {
          ...
          let headers = new Headers(response2.headers);
      ...
      response2 = await handleResourceRequest(
        serverMode,
        staticHandler,
      ...
      let criticalCss = mode === "development" ? await ((_b = (_a = getDevServerHooks()) == null ? void 0 : _a.getCriticalCss) == null ? void 0 : _b.call(_a, _build, url2.pathname)) : void 0;
      response2 = await handleDocumentRequest(
        serverMode,
        _build,
        staticHandler,
        request2,
...
async function handleManifestRequest(build, routes, url2) {
  let patches = {};
  if (url2.searchParams.has("p")) {
    for (let path3 of url2.searchParams.getAll("p")) {
      let matches = matchServerRoutes(routes, path3, build.basename);
      if (matches) {
        for (let match2 of matches) {
          let routeId = match2.route.id;
          let route3 = build.assets.routes[routeId];
          if (route3) {
            patches[routeId] = route3;
          }
        }
      }
    }
...
async function handleSingleFetchRequest(serverMode, build, staticHandler, request2, handlerUrl, loadContext, handleError) {
  let { result, headers, status: status3 } = request2.method !== "GET" ? await singleFetchAction(
    build,
    serverMode,
    staticHandler,
    request2,
  ...
  if (NO_BODY_STATUS_CODES.has(status3)) {
    return new Response(null, { status: status3, headers: resultHeaders });
  }
...
async function handleResourceRequest(serverMode, staticHandler, routeId, request2, loadContext, handleError) {
  try {
    let response2 = await staticHandler.queryRoute(request2, {
      routeId,
      requestContext: loadContext
    });
...
function unwrapResponse(response2) {
  let contentType3 = response2.headers.get("Content-Type");
  return contentType3 && /\bapplication\/json\b/.test(contentType3) ? response2.body == null ? null : response2.json() : response2.text();
}
/**
 * @react-router/node v7.1.4
 *
 * Copyright (c) Remix Software Inc.
 *
 * This source code is licensed under the MIT license found in the
...
var StreamPump = class {
  constructor(stream2) {
    ...
    __publicField(this, "accumalatedSize");
    __publicField(this, "stream");
    __publicField(this, "controller");
    this.highWaterMark = stream2.readableHighWaterMark || new Stream$2.Readable().readableHighWaterMark;
  ...
  enqueue(chunk) {
    if (this.controller) {
      try {
        let bytes2 = chunk instanceof Uint8Array ? chunk : Buffer.from(chunk);
        let available = (this.controller.desiredSize || 0) - bytes2.byteLength;
        this.controller.enqueue(bytes2);
        if (available <= 0) {
          this.pause();
        }
      } catch (error2) {
...
function createRequestHandler({
  ...
  return async (req2, res2, next) => {
    try {
      let request2 = createRemixRequest(req2, res2);
      let loadContext = await (getLoadContext == null ? void 0 : getLoadContext(req2, res2));
      let response2 = await handleRequest(request2, loadContext);
      await sendRemixResponse(res2, response2);
    } catch (error2) {
      next(error2);
    }
  };
...
function createRemixRequest(req2, res2) {
  var _a, _b;
  let [, hostnamePort] = ((_a = req2.get("X-Forwarded-Host")) == null ? void 0 : _a.split(":")) ?? [];
  let [, hostPort] = ((_b = req2.get("host")) == null ? void 0 : _b.split(":")) ?? [];
  let port = hostnamePort || hostPort;
  let resolvedHost = `${req2.hostname}${port ? `:${port}` : ""}`;
  let url2 = new URL(`${req2.protocol}://${resolvedHost}${req2.originalUrl}`);
  let controller = new AbortController();
  let init2 = {
    method: req2.method,
    headers: createRemixHeaders(req2.headers),
    signal: controller.signal
  };
  res2.on("finish", () => controller = null);
  res2.on("close", () => controller == null ? void 0 : controller.abort());
  if (req2.method !== "GET" && req2.method !== "HEAD") {
    init2.body = createReadableStreamFromReadable(req2);
    init2.duplex = "half";
  }
  return new Request(url2.href, init2);
}
async function sendRemixResponse(res2, nodeResponse) {
  var _a;
  res2.statusMessage = nodeResponse.statusText;
  res2.status(nodeResponse.status);
  for (let [key, value] of nodeResponse.headers.entries()) {
    res2.append(key, value);
  }
  if ((_a = nodeResponse.headers.get("Content-Type")) == null ? void 0 : _a.match(/text\/event-stream/i)) {
    res2.flushHeaders();
  }
  if (nodeResponse.body) {
    await writeReadableStreamToWritable(nodeResponse.body, res2);
  } else {
    res2.end();
  }
}
...
var limit = 1024;
var encode = function encode2(str, defaultEncoder, charset3, kind, format2) {
  if (str.length === 0) {
    return str;
  }
  var string = str;
...
function requireServeStatic() {
  ...
  function createRedirectDirectoryListener() {
    return function redirect3(res2) {
      ...
      var doc = createHtmlDocument2("Redirecting", "Redirecting to " + escapeHtml3(loc));
      res2.statusCode = 301;
      res2.setHeader("Content-Type", "text/html; charset=UTF-8");
      res2.setHeader("Content-Length", Buffer.byteLength(doc));
      res2.setHeader("Content-Security-Policy", "default-src 'none'");
...
app.use(
  createRequestHandler({
    ...
    build: () => import("./server-build-b0X9hDhG.js"),
    getLoadContext() {
      return {
...
export {
  ...
  useLoaderData as a,
  useActionData as b,
  createReadableStreamFromReadable as c,
  useMatches as d,
  useRouteError as e,
