...
export function MyAppNav() {
  return (
    <nav className="bg-white text-black sticky top-0 py-5 flex justify-center gap-10 shadow">
      ...
      <NavLink to="/login" className="hover:scale-110 duration-200 font-medium">Saldo information</NavLink>
      <NavLink to="/login" className="hover:scale-110 duration-200 font-medium">Top Up</NavLink>
      <NavLink to="/login" className="hover:scale-110 duration-200 font-medium">Withdraw</NavLink>
      <NavLink to="/login" className="hover:scale-110 duration-200 font-medium">Transaction</NavLink>
